...
//static bool s_PlatformInit_Success = false;
//static void TestQiyuPlatformAPIs()
//{
//	if (!s_PlatformInit_Success)
//	{
//		LOGE_("@@TestQiyuPlatformAPIs, async message s_PlatformInit_Success is not true yet.");
//		return;
//	}
//
...
void Callback_PlatformInit(const PResult_Init& result)
{
	...
	if (result.IsSuccess())
	{
		...
		//TestQiyuPlatformAPIs();
	}
}
//static void TestQiyuPlatform()
//{
//	static bool bInitPlatform = false;
//	if (!bInitPlatform)
//	{
...
//static void TestQiyuPrefs()
//{
//	auto lambda_LogGetState_ = []() {
...
//	};
//
//	//Init first,only need once,first time will show permisson dialog.
//	static bool bInitPrefs = false;
//	if (!bInitPrefs)
//	{
//		qiyu_Prefs_Init();
//		bInitPrefs = true;
//		LOGI_("qiyu_Prefs_Init done.");
//	}
//	assert(bInitPrefs);
//	//Save data test
//	lambda_LogGetState_();
//	//
//	qiyu_Prefs_SetInt("Int", 1);
//	LOGI_("qiyu_Prefs_SetInt: 1");
//	qiyu_Prefs_SetFloat("Float", 0.333f);
//	LOGI_("qiyu_Prefs_SetFloat: 0.333f");
//	qiyu_Prefs_SetString("String", "abc123");
//	LOGI_("qiyu_Prefs_SetString: abc123");
//	//
//	lambda_LogGetState_();
//	//
...
static void CommandCallback(struct android_app* app, int32_t cmd)
{
	...
	case APP_CMD_DESTROY:
	{
		...
		QYApp_Release(&qyApp->qyEgl);//FIXME!
		break;
	}
